...
#df_spMCI=readZscore("./ML/LogReg_noPCA_spMCI_Fix_HarmZ_JADNI_AD.xlsx")
#LogitTransform
df_spMCI=df_spMCI%>%mutate(Prob=log(Prob/(1-Prob)))
df_spMCI[which(df_spMCI$Prob == Inf, TRUE),"Prob"] <- max(df_spMCI$Prob[is.finite(df_spMCI$Prob)])
## Get ROInames
